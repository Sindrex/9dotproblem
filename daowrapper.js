...
module.exports = class DaoWrapper extends Dao {
  ...
  createOneRaw(json, callback) {
    ...
    super.query(
      ...
      "created_at, player_id, try_nr, point1, point2, point3, point4, point5, timer1, timer2, timer3, timer4, timer5, timer6, timer7, timer8, totalTime, hasTabbedOut, totalTabbedOutTime" +
      ") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
      valRaw,
      callback
    );
